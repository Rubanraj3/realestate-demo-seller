...
export class GolivestreamComponent implements OnInit, OnDestroy, DoCheck {
  constructor(private dash: DashboardService, public route: ActivatedRoute, public api: ManagelivestreamService, public stream: AgorastreamingService, public router: Router, public agora: HostserviceService, public web: SocketioService, private leave: PendingChangesGuard) { }
